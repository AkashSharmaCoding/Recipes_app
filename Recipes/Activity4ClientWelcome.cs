...
namespace Recipes
{
    [Activity(Label = "Activity4ClientWelcome")]
    public class Activity4ClientWelcome : Activity
    {
        TextView welcomeMsg;
        String myusername;
        Spinner AWspinner;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.ClientWelcome);
